...
#include "Galaga_USFX_Adapter/BallAdapter.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	GALAGA_USFX_ADAPTER_API UClass* Z_Construct_UClass_ABallAdapter_NoRegister();
	GALAGA_USFX_ADAPTER_API UClass* Z_Construct_UClass_ABallAdapter();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABallAdapter_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ABallAdapter_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UBounce_Ball_NoRegister, (int32)VTABLE_OFFSET(ABallAdapter, IBounce_Ball), false },
		};
	...
	IMPLEMENT_CLASS(ABallAdapter, 2124594836);
	template<> GALAGA_USFX_ADAPTER_API UClass* StaticClass<ABallAdapter>()
	{
		return ABallAdapter::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABallAdapter(Z_Construct_UClass_ABallAdapter, &ABallAdapter::StaticClass, TEXT("/Script/Galaga_USFX_Adapter"), TEXT("ABallAdapter"), false, nullptr, nullptr, nullptr);
