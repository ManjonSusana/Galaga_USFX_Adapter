...
#define UE_PROJECT_NAME Galaga_USFX_Adapter
#define UE_TARGET_NAME Galaga_USFX_AdapterEditor
#define UE_MODULE_NAME "Galaga_USFX_Adapter"
...
#define GALAGA_USFX_ADAPTER_API DLLEXPORT
